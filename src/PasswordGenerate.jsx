...
export default function PasswordGenerate() {
    ...
    let [range, setRange] = useState(10); // Initialize range as number
    ...
    const copy = async () => {
        try {
            const passwordStr = password.join(""); // Join array to string before copying
            await navigator.clipboard.writeText(passwordStr);
        ...
        <div className='outerdiv'>
            ...
            <div className='range'>
                ...
                <input
                    ...
                    min={3}
                    max={20}
                    onChange={(e) => setRange(Number(e.target.value))} // Ensure range is a number
                /><br />
            </div>
            <div className='clickbox'>
                ...
                <input
                    ...
                    checked={NumberCase}
                />Include Numbercase Letter <br />
                <input
                    type="checkbox"
                    onChange={(e) => setSymbolCase(e.target.checked)}
                    checked={SymbolCase}
                />Include Symbole Letter <br />
            </div><br /><br />
            <div className="btn">
